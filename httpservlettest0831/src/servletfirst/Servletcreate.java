...
//serialVersionUID 가 있는 이유 : Serializable 인터페이스를 implements 한 경우, 구분하기 위한 코드 - 없으면 경고가 발생한다.(에러는 x)
...
//post 방식으로 요청이 왔을 때 호출되는 메소드
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		//처리를 doGet에게 위임(delegate=델리게이트)
